...
class BigMonster extends Monster{
        ...
        public boolean taskMonster(int difficultGame){
            ...
            if (difficultGame == 1){
                ...
                int x = r.nextInt(20 * (difficultGame - 1), 10 * difficultGame);
                int y = r.nextInt(18 * (difficultGame - 1), 10 * difficultGame);
                int z = r.nextInt(100 * (difficultGame - 1), 120 * difficultGame);
